...
const FlagWalletRepo = "offlinewallet"

func main() {
	api.RunningNodeType = api.NodeOfflineWallet
	...
	app := &cli.App{
		Name:                 "offline-wallet",
		Usage:                "Offline wallet for security consideration.",
	...
	app.Metadata["repoType"] = repo.Wallet
